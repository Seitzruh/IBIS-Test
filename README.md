# IBIS-Test
an Android APP to send IBIS codes (VDV300) via USB to the IBIS bus with the LYNX Adapter from Julian Metzler. See https://xatlabs.com/de/produkte/lynx/
This Andoid APP uses the USB to Serial lib from Mike Wakerly see https://github.com/mik3y/usb-serial-for-android
...
If you have any questions feel free to send me an email: helmut.seitz@bconn.de
